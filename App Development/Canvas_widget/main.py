...
def start_timer():
    ...
    if reps == 8:
        ...
        count_down(work_sec)
        timer_label.config(text="Work-hour", fg=GREEN)
...
timer_text = canvas.create_text(105, 130, text="00:00", fill="white", font=(FONT_NAME,  31, "bold"))
canvas.grid(column=2, row=2)


timer_label = Label(text="Timer", fg=GREEN, bg=YELLOW, font=(FONT_NAME,  27, "bold"))
